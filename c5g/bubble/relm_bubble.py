...
with ReLMLoader(__file__, loader=loader):
    ...
    Thread[
        ...
        Do()[
            ...
            Play(audio_shift, fifo_audio, "c5g/bubble/cast_dice.npy"),
            Continue(),
            BONUS := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/bonus.npy"),
            Continue(),
            WALK := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/walk.npy"),
            Continue(),
            BUY := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/buy.npy"),
            Continue(),
            PURCHASE := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/purchase.npy"),
            Continue(),
            CRISIS := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/crisis.npy"),
            Continue(),
            SELL := Label(),
            audio_state(NO_SOUND),
            ...
            WIN := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/win.npy"),
            Continue(),
            LOSE := Label(),
            audio_state(NO_SOUND),
            Play(audio_shift, fifo_audio, "c5g/bubble/lose.npy"),
            Continue(),
            NO_SOUND,
        ],
    ]
    ...
    Thread[
        ...
        console.Print("Introduction:", v := v + V8 * 2, 0xF0),
        console.Print(
        ...
        console.Print("Playable Demo:", v := v + V8 * 3),
        console.Print(
        ...
        console.Print("Let's play the new technology!", (v := v + V8 * 3) + h),
        console.Print("Goal:", v := v + V8 * 3),
        console.Print(
        ...
        console.Print("Move:", v := v + V8 * 3),
        console.Print(
            "Roll dice and move forward according to the number on the dice.",
            (v := v + V8 * 2) + h,
        ),
        console.Print(
            'Roll dice by pressing "Enter" or clicking the mouse, and then',
            (v := v + V8 * 2) + h,
        ),
        console.Print(
            "choose the next cell with the cursor keys or moving the mouse.",
            (v := v + V8 + V4) + h,
        ),
        v := v + V8 * 2,
        console.Print("     ", v + V8 * 0 + h, 0xF1),
        console.Print("     ", v + V8 * 1 + h),
        console.Print("     ", v + V8 * 2 + h),
        console.Print("  200", v + V8 * 3 + h),
        console.Print("  200", v + V8 * 4 + h),
        console.Print("     ", v + V8 * 0 + h + 6 * 2),
        console.Print("     ", v + V8 * 1 + h + 6 * 2),
        console.Print("     ", v + V8 * 2 + h + 6 * 2),
        console.Print("  200", v + V8 * 3 + h + 6 * 2),
        console.Print("  200", v + V8 * 4 + h + 6 * 2),
        console.Print("     ", v + V8 * 0 + h + 12 * 2),
        console.Print("     ", v + V8 * 1 + h + 12 * 2),
        console.Print("     ", v + V8 * 2 + h + 12 * 2),
        console.Print("  200", v + V8 * 3 + h + 12 * 2),
        console.Print("  200", v + V8 * 4 + h + 12 * 2),
        console.Print(" ", v + V8 * 2 + h + 11 * 2, 0xFF),
        ...
        console.Print(
            'You can change your way to go until pressing "Enter" or clicking the mouse',
            (v := v + V8 * 2) + h,
        ),
        console.Print(
        ...
        console.Print("Events:", v := v + V8 * 3),
        console.Print(
            "Gray cells represent vacant lots of land.", (v := v + V8 * 2) + h
        ),
        v := v + V8 * 2,
        console.Print("     ", v + V8 * 0 + h, 0xF1),
        console.Print("     ", v + V8 * 1 + h),
        ...
        console.Print("  200", v + V8 * 4 + h),
        console.Print(
            "The number in each cell shows the land price.",
            v + V8 * 3 + h + 6 * 2,
            0xF0,
        ),
        console.Print(
        ...
        v := v + V8 * 2,
        console.Print("     ", v + V8 * 0 + h, 0xF3),
        console.Print("     ", v + V8 * 1 + h),
        console.Print("     ", v + V8 * 2 + h),
        console.Print("  750", v + V8 * 3 + h),
        console.Print("  300", v + V8 * 4 + h),
        console.Print("     ", v + V8 * 0 + h + 6 * 2),
        console.Print("     ", v + V8 * 1 + h + 6 * 2),
        console.Print("     ", v + V8 * 2 + h + 6 * 2),
        console.Print("  750", v + V8 * 3 + h + 6 * 2),
        console.Print("  450", v + V8 * 4 + h + 6 * 2),
        console.Print("\x02", v + V8 * 2 + h + 5 * 2, 0xF0),
        console.Print(
        ...
        console.Print(
            "and the lower value is the price of each lot.", v + V8 * 4 + h + 12 * 2
        ),
        console.Print(
        ...
        console.Print("increase in your total assets.", (v := v + V8 + V4) + h),
        console.Print(
        ...
        console.Print("yellow cell.", (v := v + V8 + V4) + h),
        v := v + V8 * 2,
        console.Print("     ", v + V8 * 0 + h, 0x62),
        console.Print("     ", v + V8 * 1 + h),
        console.Print("     ", v + V8 * 2 + h),
        console.Print("BONUS", v + V8 * 3 + h),
        console.Print("  100", v + V8 * 4 + h),
        console.Print('The "', v + V8 * 2 + V4 + h + 6 * 2, 0xF0),
        console.Print("BONUS", color=0x62),
        console.Print(
            '" message will disappear and nothing will happen unless you',
            color=0xF0,
        ),
        console.Print("are the owner of the smallest assets.", v + V8 * 4 + h + 6 * 2),
        console.Print(
            "Once you get a bonus, you will have next bonus to increase by 50%.",
            (v := v + V8 * 6) + h,
        ),
        console.Print("Tip:", v := v + V8 * 3),
        console.Print(
